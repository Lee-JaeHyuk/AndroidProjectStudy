package com.example.multi_touch_app;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(new MultTouchView(this, null));

    }

    public class MultTouchView extends View{
        ...
        public MultTouchView(Context context, Attributes attrs) {
            super(context);
            initView();
        }
